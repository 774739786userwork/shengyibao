...
public class BillingPickPictureActivity extends BaseActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            try {
                checkSMSPermission = ContextCompat.checkSelfPermission(BillingPickPictureActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
                if (checkSMSPermission != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(BillingPickPictureActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, MY_PERMISSIONS_REQUEST_CAMERA);
                    return;
                }else {
                    initData();
                }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
                    ...
                    imageView, options, new SimpleImageLoadingListener() {
                        public void onLoadingComplete(Bitmap loadedImage) {
                            Animation anim = AnimationUtils.loadAnimation(
                                    BillingPickPictureActivity.this, R.anim.fade_in);
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                public void onClick(View arg0) {
                    Intent intent = new Intent(BillingPickPictureActivity.this,ShowImageActivity.class);
                    intent.putStringArrayListExtra("ImageUrl",mList);
                    intent.putExtra(ShowImageActivity.EXTRA_IMAGE_INDEX,position);
                    BillingPickPictureActivity.this.startActivity(intent);
                }
            });
