 ...
 *
 */
public class BillingPickPictureAdapter extends BaseAdapter {
											...
											Dialog deleteDialog = new AlertDialog.Builder(context)
													...
													.setPositiveButton("确定", new DialogInterface.OnClickListener() {
														public void onClick(DialogInterface dialog, int which) {
															...
															BillingPickPictureAdapter.this.notifyDataSetChanged();
														}
													})
	...
	public BillingPickPictureAdapter(Context context, ArrayList<String> listCaremaName, boolean candelete) {
		super();
