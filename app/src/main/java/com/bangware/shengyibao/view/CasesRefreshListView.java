 ...
 * 案例独有的刷新加载控件
 */
public class CasesRefreshListView extends ListView implements OnScrollListener {
	...
	private OnCasesRefreshListener mOnRefershListener;
	private boolean isScrollToBottom; // 是否滑动到底部
	private View footerView; // 脚布局的对象
	private int footerViewHeight; // 脚布局的高度
	private boolean isLoadingMore = false; // 是否正在加载更多中

	public CasesRefreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initHeaderView();
		initFooterView();
	 ...
	 * @param listener
	 */
	public void setOnRefreshListener(OnCasesRefreshListener listener) {
