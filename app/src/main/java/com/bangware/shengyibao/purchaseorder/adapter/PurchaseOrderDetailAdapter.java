...
public class PurchaseOrderDetailAdapter extends BaseAdapter {
	...
	public PurchaseOrderDetailAdapter(Context context, List<DeliveryNoteGoods> goodslist){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.item_purchaseorder_detail, null);
		}
		final ImageView product_image = ViewHolder.get(convertView, R.id.purchase_detail_Product_Image);
		TextView  product_name = ViewHolder.get(convertView, R.id.purchase_detail_GoodsList_Product_Name);
		TextView  product_saler_money = ViewHolder.get(convertView, R.id.purchase_detail_GoodsList_Sale_Summary);
		TextView  product_saler_quantity = ViewHolder.get(convertView, R.id.purchase_detail_Product_SalesVolume);
		TextView  product_gift_quantity = ViewHolder.get(convertView, R.id.purchase_detail_Product_GiftsVolume);
		TextView  product_total_amount = ViewHolder.get(convertView, R.id.purchase_detail_Product_SubtotalAmount);
		TextView  p_totalforegift=ViewHolder.get(convertView,R.id.purchase_totalforegift);
		TextView  p_totalforegift_txt=ViewHolder.get(convertView,R.id.purchase_totalforegift_txt);
