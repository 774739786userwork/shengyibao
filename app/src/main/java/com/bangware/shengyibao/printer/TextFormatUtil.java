...
public class TextFormatUtil {
    ...
    public static void main(String[] args){
    	TextFormatUtil tfu = new TextFormatUtil();
    	StringBuffer sb = new StringBuffer();
    	sb.append(tfu.getLineTitle("多邦建材\n送货单"));
    	...
    	leftMsgMap.put("店名", "湘衡建材");
    	leftMsgMap.put("地址", "红星建材市场18号");
    	
    	sb.append(tfu.printSymmetryMSG(leftMsgMap, rightMsgMap));
    	tfu.addLineElement("内墙腻子粉小包", 1);
    	tfu.addLineElement("内墙腻子粉小包", 1);
    	
    	sb.append(tfu.endLine());
