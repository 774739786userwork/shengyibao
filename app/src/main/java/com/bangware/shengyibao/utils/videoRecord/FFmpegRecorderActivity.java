...
public class FFmpegRecorderActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    private int currentResolution = Constants_Camera.RESOLUTION_MEDIUM_VALUE;
     ...
     * 按住拍控件
     */
    private CircleBackgroundTextView btn_press;
    /**
     * 按住拍 字体颜色
     */
    ...
    private void initLayout()
    {
        ...
        btn_press = (CircleBackgroundTextView) findViewById(R.id.btn_press);
         ...
         * 设置按下键文本与圆圈颜色
         */
        btn_press.setTextColor(PRESS_BTN_COLOR);
        btn_press.setCircleColor(PRESS_BTN_BG);
    }
    ...
    private void initCameraLayout() {
        new AsyncTask<String, Integer, Boolean>(){
            ...
            protected void onPostExecute(Boolean result) {
                ...
                btn_press.setOnTouchListener(FFmpegRecorderActivity.this);//按下触摸事件
    ...
    private void initVideoRecorder() {
        strVideoPath = VideoUtils.createFinalPath(this);//VideoUtils.createTempPath(tempFolderPath);

        RecorderParameters recorderParameters = VideoUtils.getRecorderParameter(currentResolution);
    ...
    public class AsyncStopRecording extends AsyncTask<Void,Integer,Void>{
        ...
        private void getFirstCapture(byte[] data){
            ...
            String captureBitmapPath = Constants_Camera.CAMERA_FOLDER_PATH;

            captureBitmapPath = VideoUtils.createImagePath(FFmpegRecorderActivity.this);
        ...
        protected Void doInBackground(Void... params) {
            if(firstData != null)
//                getFirstCapture(firstData);不进行图片保存
                isFinalizing = false;
    ...
    class AudioRecordRunnable implements Runnable {
        ...
        private void updateTimestamp()
        {
            if (videoRecorder != null)
            {
                int i = VideoUtils.getTimeStampInNsFromSampleCounted(this.mCount);
...
//	    }
    ...
    private void handleSurfaceChanged()
    {
        ...
        if(Build.VERSION.SDK_INT >  Build.VERSION_CODES.FROYO)
        {
            mCamera.setDisplayOrientation(VideoUtils.determineDisplayOrientation(FFmpegRecorderActivity.this, defaultCameraId));
    ...
    {
        Uri videoTable = Uri.parse(Constants_Camera.VIDEO_CONTENT_URI);

        VideoUtils.videoContentValues.put(Video.Media.SIZE, new File(strVideoPath).length());
        try{
            uriVideoPath = getContentResolver().insert(videoTable, VideoUtils.videoContentValues);
        } catch (Throwable e){
            uriVideoPath = null;
            strVideoPath = null;
            e.printStackTrace();
        } finally{}
        VideoUtils.videoContentValues = null;
    }
